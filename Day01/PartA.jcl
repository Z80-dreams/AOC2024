//AOC2401A JOB (EGEN),'AOC2401A',CLASS=A,MSGCLASS=Q,                            
...
/*                                                                              
//*---------------------------------------------------------------------        
//* CALCULATE THE DIFF AND THEN SUM THE DIFF.                                   
//*---------------------------------------------------------------------        
//DIFF     EXEC PGM=SORT                                                        
//SORTOUT  DD SYSOUT=*                                                          
...
//SYSIN    DD *                                                                 
  OPTION COPY                                                                   
  INREC OVERLAY=(30:(8,5,ZD,SUB,18,5,ZD),SIGNS=(,))                             
  OUTFIL REMOVECC,                                                              
         TRAILER1=(1:'Total: ',30:TOT=(30,15,ZD))                               
